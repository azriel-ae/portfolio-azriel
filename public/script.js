...
const translations = {
  id: {
    ...
    hero_role: "Merancang dan mengembangkan aplikasi web modern yang berfokus pada fungsionalitas, kemudahan penggunaan, dan solusi nyata — mulai dari platform khusus hingga tools pemrosesan digital.",
  ...
  en: {
    ...
    hero_eyebrow: "Web Development",
    hero_role_short: "Web Development",
    hero_role: "Designing and developing modern web applications focused on functionality, usability, and real-world solutions — from custom platforms to digital processing tools.",
