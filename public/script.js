...
const translations = {
  id: {
    ...
    about_text: "Saya Azriel Aurizal Ednisia, siswa sekolah menengah kejuruan dan web developer dengan minat besar pada pengembangan software dan teknologi web modern. Saya senang mengubah ide menjadi produk digital yang fungsional dan terstruktur dengan baik, mulai dari merancang antarmuka yang intuitif hingga mengembangkan aplikasi yang andal dan bekerja dengan database. Saya berfokus membangun project yang praktis dan menyelesaikan masalah nyata, dengan tetap menjaga struktur kode yang bersih, performa, dan kemudahan pemeliharaan. Melalui setiap project, saya terus berupaya meningkatkan kemampuan teknis dan menciptakan software yang bermanfaat serta dibangun dengan cermat.",
